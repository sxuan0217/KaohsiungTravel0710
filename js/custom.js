...
function printData(e) {
    ...
    for (var i = 0; attractionLen > i; i++) {
        ...
        str += '<div class="picture"style="background-image: url(' + attractions[i].Picture1 + ')";></div>';
        str += '<div class="countryInfo">';
        str += '<p><img class="iconSet" src="./img/icons_clock.png" alt="">' + attractions[i].Opentime + '</p>';
        str += '<p><img class="iconSet" src="./img/icons_pin.png" alt="">' + attractions[i].Add + '</p>'
        str += '<p><img class="iconSet" src="./img/icons_phone.png" alt="">' + attractions[i].Tel + '</p>'
        str += '<p class="right"><img class="iconSet" src="./img/icons_tag.png" alt="">' + attractions[i].Ticketinfo + '</p>'
        str += '</div>'
        str += '</li>';
         }
